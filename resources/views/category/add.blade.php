			...
			<div class="row">
              ...
              @endif
							...
							<div class="card">
								...
								<div class="card-body">
									<form class="form form-horizontal" id="form_category" method="post" action="/category/add" enctype="multipart/form-data">
										@csrf
										<div class="row">
											<div class="col-12">
												<div class="mb-1 row">
													...
													<div class="col-sm-10">
														<input id="name" class="form-control @error('category_name') is-invalid @enderror" 
															name="category_name" placeholder="Category Name" value={{ old('category_name') }}>
														@error('category_name')
