						...
						<div class="card mb-0">
							<div class="card-body">
								<a href="#" class="brand-logo">
									<h2 class="brand-text text-success ms-1">Mini Pos Admin</h2>
								</a>

								<h4 class="card-title mb-1">Welcome to Mini Pos! 👋</h4>
								...
								<form class="auth-login-form mt-2" action="/login" method="POST">
									...
									<div class="mb-1">
										...
										<input type="text" class="form-control" id="login-email" name="username" placeholder="johndoe123" aria-describedby="login-email" tabindex="1" autofocus required/>
									</div>
